...
import ma.emsi.ingestionvideo.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<AuthResponse>> register(@RequestBody CreateReporterRequest request) {
        AuthResponse auth = authService.register(request);
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .body(ApiResponse.success("New reporter is registered", auth));
    }
